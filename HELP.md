...
* The original package name 'com.karthik.task-management-backend' is invalid and this project uses 'com.karthik.task_management_backend' instead.
...
* [OAuth2 Client](https://docs.spring.io/spring-boot/3.5.12-SNAPSHOT/reference/web/spring-security.html#web.security.oauth2.client)
